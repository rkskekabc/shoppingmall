...
public class ProductOptionController {
	...
	@ApiOperation(value="상품옵션 가져오기")
	@GetMapping("/")
	public ResponseEntity<JSONResult> getList() {
		List<ProductOptionVo> list = productOptionService.getList();
	...
	@PostMapping("/")
	public ResponseEntity<JSONResult> insert(@RequestBody ProductOptionVo vo) {
	...
	@PutMapping("/")
	public ResponseEntity<JSONResult> update(@RequestBody ProductOptionVo vo) {
